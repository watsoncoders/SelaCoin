...
This document provides guidelines for internationalization of the SelaCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `selacoin_en.ts` remains unchanged.
