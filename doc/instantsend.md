...
This mechanism has been integrated into Bitcore-Node-SelaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/selacoinpay/insight-api-selacoin#web-socket-api](https://github.com/selacoinpay/insight-api-selacoin#web-socket-api)
* API: [https://github.com/selacoinpay/insight-api-selacoin#instantsend-transactions](https://github.com/selacoinpay/insight-api-selacoin#instantsend-transactions)
