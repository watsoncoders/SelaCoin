...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 SELA from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 SELA in block rewards plus fees, but
        ...
        # Send 100 SELA with subtract fee from amount
        ...
        # Sendmany 100 SELA with subtract fee from amount
