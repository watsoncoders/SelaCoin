...
from test_framework.test_framework import SelaCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(SelaCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SelaCoinTestFramework doesn't support this atm)
