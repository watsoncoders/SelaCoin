...
#define BOOST_TEST_MODULE SelaCoin Test Suite

#include "test_selacoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_selacoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
