/* src/config/selacoin-config.h.  Generated from selacoin-config.h.in by configure.  */
/* src/config/selacoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SELA_CONFIG_H

#define SELA_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SelaCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SelaCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/selacoinpay/selacoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SelaCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SelaCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "selacoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://selacoin.org/"
