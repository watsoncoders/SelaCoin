...
#if defined(NDEBUG)
# error "SelaCoin cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 14400;
unsigned int nStakeMinAge = 240 * 60 * 60; // 240 hours
...
const string strMessageMagic = "SelaCoin Signed Message:\n";
