...
//! These need to be macros, as clientversion.cpp's and selacoin*-res.rc's voodoo requires it
...
/**
 * selacoind-res.rc includes this file, but it cannot cope with real c++ code.
