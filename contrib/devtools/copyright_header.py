...
Arguments:
    <base_directory> - The base directory of a SelaCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SelaCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of SelaCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the SelaCoin Core repository.
"""
